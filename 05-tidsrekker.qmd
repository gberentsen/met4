...
aliases:
  - ar.html
  - arma-arima.html
  - autokorrelasjon.html
  - intro.html
  - ma.html
  - modellbygging-1.html
  - oppgaver-2.html
  - relevante-r-tidsrekker.html
  - stasjonaritet.html
  - tidsrekker.html
  - trend-og-sesong.html
---
...
## Introduksjon til tidsrekker {#sec-intro}
...
## Trend og sesong {#sec-trend-og-sesong}
...
## Stasjonaritet {#sec-stasjonaritet}
...
## Autokorrelasjon {#sec-autokorrelasjon}
...
## Relevante R-kommandoer {#sec-relevante-r-tidsrekker}
...
### Tidsrekkedata {.unnumbered}

I tidsrekkemodulen må vi håndtere følgende når det gjelder datasettene:
...
### Plotte en tidsrekke {.unnumbered}
...
### Glidende gjennomsnitt {.unnumbered}
...
### Eksponensiell glatting {.unnumbered}
...
### Dekomponering i trend, sesong og residualer {.unnumbered}
...
### Autokorrelasjonsplott (ACF) {.unnumbered}
...
### Estimere ARIMA-modeller {.unnumbered}
...
### Automatisk modellvalg {.unnumbered}
...
### Dele opp i trenings- og testsett {.unnumbered}
...
### Out-of-sample vurdering {.unnumbered}
...
### Simulere tidsrekker {.unnumbered}
