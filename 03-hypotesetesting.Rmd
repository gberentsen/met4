...
En **hypotese** er en påstand om en ukjent størrelse i en populasjon, for eksempel om at et parti har oppslutning over sperregrensen, eller at forventet vekt på et produkt er en bestemt verdi. Vitenskapsfilosofen Karl Popper påpekte at gode hypoteser må være *falsifiserbare*: det må finnes tenkelige observasjoner som kan *motbevise* dem. Et viktig poeng følger av dette: at en hypotese ennå ikke er forkastet, betyr ikke at den er sann. Newtons fysikk sto uimotsagt i århundrer før Einstein viste at den bare var tilnærmet riktig.

Statistisk hypotesetesting bygger på nettopp denne tankegangen. Vi setter opp *to* konkurrerende hypoteser:
...
En hypotesetest kan settes opp i fem steg. Vi følger dem med et konkret eksempel: *har partiet Venstre oppslutning over sperregrensen på 4 %?*
...
Steg 5 er kjernen, og «overrasket» har en presis betydning: er $H_0$ sann, følger testobservatoren en kjent fordeling (en samplingfordeling), og vi kan regne ut hvor sannsynlig det er å få en verdi som er *minst så ekstrem* som den vi observerte. Er den sannsynligheten liten, er dataene vanskelige å forene med $H_0$.
...
|---|:---:|:---:|
| **Vi forkaster $H_0$** | Type I-feil | Riktig |
| **Vi beholder $H_0$** | Riktig | Type II-feil |
...
Alternativhypotesen kan peke i én eller begge retninger:

- I en **tosidig** test er $H_A: \mu \neq \mu_0$. Vi bryr oss om avvik i *begge* retninger, og forkastningsområdet legges i begge haler av fordelingen.
- I en **ensidig** test er $H_A: \mu > \mu_0$ (eller $\mu < \mu_0$), og hele forkastningsområdet legges i én hale. Venstre-eksempelet er ensidig: vi er bare interessert i om oppslutningen er *over* sperregrensen.
...
```
Vi ser at testobservatoren har samme verdi som i Excel-gjennomgangen. Kritisk verdi finner vi rett fra R:
...
Signifikansnivået er satt til $\alpha = 1\%$ i eksempelet. Kritisk verdi finner vi rett fra R:
