...
2. **Oversett til $H_0$ og $H_A$.** Vi skriver spørsmålet som to hypoteser om populasjonsstørrelsen, og noterer hvilke antakelser vi gjør om populasjonen. Her: $H_0: p = 0.04$ mot $H_A: p > 0.04$.
3. **Samle data.** Vi trekker et utvalg fra populasjonen, for eksempel ved å spørre 1000 tilfeldig valgte velgere hva de vil stemme.
4. **Beregn testobservatoren.** Vi oppsummerer dataene i én tallstørrelse, en **testobservator**, som tallfester hvor mye beviset taler mot $H_0$. Poenget med en testobservator er at vi kjenner **fordelingen dens når $H_0$ er sann**.
5. **Vurder signifikans og konkluder.** Vi spør hvor overraskende testobservatoren er dersom $H_0$ er sann. Er vi tilstrekkelig overrasket, forkaster vi $H_0$.
...
I Venstre-eksempelet, dersom testobservatoren ga en p-verdi på 0.0006, ville vi ved $\alpha = 0.01$ forkastet $H_0$ og konkludert med at resultatet tyder på oppslutning over sperregrensen.
