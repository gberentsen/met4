...
```{r forkastning, echo = FALSE, message = FALSE, fig.width = 6.5, fig.height = 3.3, fig.cap = "Fordelingen til testobservatoren under $H_0$ (standardnormalfordelingen) i Venstre-eksempelet. Forkastningsområdet på 5 % er skyggelagt, med den kritiske verdien 1.645 som grense. Den observerte testobservatoren $Z = 2.42$ faller innenfor forkastningsområdet, så vi forkaster."}
library(ggplot2)
...
ggplot(kurve, aes(x, tetthet)) +
  ...
  geom_segment(aes(x = zobs, xend = zobs, y = 0, yend = dnorm(zobs)),
               colour = "firebrick", linewidth = 0.9) +
  annotate("text", x = 2.55, y = 0.075, label = "Forkastnings-\nområde (5 %)", size = 3) +
  annotate("text", x = 0.95, y = 0.30, label = "kritisk verdi\n1.645", size = 3) +
  annotate("segment", x = 1.15, xend = zkrit, y = 0.27, yend = 0.20,
           arrow = arrow(length = unit(0.15, "cm"))) +
  annotate("text", x = 2.95, y = 0.16, label = "observert\nZ = 2.42", colour = "firebrick", size = 3) +
