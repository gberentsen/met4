...
Når vi vil sammenligne forventningene i to *uavhengige* grupper, tester vi $H_0: \mu_1 = \mu_2$, altså at differansen $\mu_1 - \mu_2$ er null. Testobservatoren er differansen mellom de to utvalgsgjennomsnittene, målt i antall standardfeil:
...
Løsningen er å se på *differansen* innenfor hvert par, $d_i = x_i - y_i$. Da sammenligner vi hver butikk med seg selv, forskjellene i størrelse mellom butikkene faller bort, og bare selve effekten (pluss litt måletilfeldighet) blir igjen. På differansene gjør vi så en helt vanlig ett-utvalgs t-test: $H_0: \mu_d = 0$, med testobservator
