...
2. **Sett opp hypotesene og velg signifikansnivå.** Vi skriver spørsmålet som to hypoteser om populasjonsstørrelsen, og bestemmer på forhånd hvor sterkt beviset må være. Her: $H_0: p = 0.04$ mot $H_A: p > 0.04$, med signifikansnivå $\alpha = 5\,\%$.
...
Poenget med en testobservator er at vi kjenner **fordelingen dens når $H_0$ er sann**: her er $Z$ da en trekning fra standardnormalfordelingen.
...
Det finnes to likeverdige måter å ta beslutningen på i steg 5, og de gir alltid samme konklusjon:

- **p-verdien:** regn ut sannsynligheten for en testobservator minst så ekstrem som den observerte, gitt $H_0$, og forkast dersom denne er liten.
- **Forkastningsområdet:** finn på forhånd de mest ekstreme verdiene testobservatoren kan ta (forkastningsområdet), og forkast dersom den observerte verdien lander der. Grensen kalles den **kritiske verdien**.
