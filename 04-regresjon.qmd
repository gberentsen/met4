---
aliases:
  - enkel-regresjon.html
  - modellbygging.html
  - multippel-regresjon.html
  - oppgaver-1.html
  - regresjon.html
  - relevante-r-regresjon.html
---
...
1. Hvorfor sier vi at følgende modell er lineær? $Y = \beta_0 + \beta_1X + \beta_1X^2 + \epsilon$
...
a) Er det grunn til å være bekymret for utelatt variabelskjevhet her? I hvilken retning påvirker den i så fall koeffisienten $\beta_1$?

b) Økonomen argumenterer for at $\beta_1$ måler hvor mye høyere lønn en arbeidstaker får, dersom den tar ett års ekstra utdanning. Er dette en rimelig tolkning? 

c) Hvordan ville du tolket $\beta_1$?
...
#### Oppgave 2 {.unnumbered}
Denne oppgaven følger samme premiss som oppgave 1, men handler om kolinearitet. Last ned datasettene [1](datasett/colinearity_1.RData) og [2](datasett/colinearity_2.RData), hvor y er responsvariabel og forklaringsvariable er navngitt x.
...
# save(df_colin1, file = "datasett/colinearity_1.RData")
set.seed(4)
...
# save(df_colin2, file = "datasett/colinearity_2.RData")
```
...
## Relevante R-kommandoer {#sec-relevante-r-regresjon}
...
### Tilpasse en lineær regresjonsmodell {.unnumbered}
...
### Prediksjoner, med konfidens- og prediksjonsintervall {.unnumbered}
