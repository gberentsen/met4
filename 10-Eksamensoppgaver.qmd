---
aliases:
  - eksamensoppgaver.html
  - skoleeksamen.html
  - tidligere-hjemmeeksamen.html
---
...
## Tidligere skoleeksamener {#sec-skoleeksamen}
...
# Gjør om markdown-lenkene [tekst](url) i cellene til HTML slik at de blir klikkbare
md2a <- function(x) gsub("\\[([^]]+)\\]\\(([^)]+)\\)", '<a href="\\2">\\1</a>', x)

skoleeksamen %>%
  mutate(across(where(is.character), md2a)) %>%
  kableExtra::kbl(escape = FALSE) %>%
  kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
```

### Rettelser og kommentarer til oppgaver og løsningsforslag {.unnumbered}

Her vil du finne en del kommentarer og rettelser som er spesifikke for de enkelte oppgavesettene. Overskriftene under kan trykkes på, så ekspanderes innholdet for hver eksamen.
