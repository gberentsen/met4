...
1. Start med å installere R:
    - Gå til [cloud.r-project.org](https://cloud.r-project.org/)
...
2. Installer så RStudio:
    - Gå til [posit.co/download/rstudio-desktop](https://posit.co/download/rstudio-desktop/). Der laster du ned **RStudio**-programmet for ditt operativsystem og installerer på vanlig måte.
...
**Oppgave 2.6.** Vi skal nå lage et histogram av hver av gruppene du lagret som vektorer i tidligere. Vi kan først kikke på Figur \@ref(fig:hist-avkastning) og koden som lagde disse figurene for å få en idé om hva vi må gjøre. Et svært viktig punkt er føgende:
