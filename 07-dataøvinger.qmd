---
aliases:
  - dataving-1---grunnleggende-statistikk.html
  - dataving-2.html
  - dataving-3.html
  - dataving-4.html
  - dataving-5.html
...
Du ser at det har kommet et nytt objekt som heter `violence`. En tilsvarende oversikt finner du i vinduet øverst til høyre i RStudio (se @fig-rstudio1) hvor du også kan klikke på objektet for å se nærmere på det.
...
**Oppgave 2.4:** Juster på argumentene i `geom_line()`-funskjonene, og legg til flere "lag" på samme måte som vi gjorde for å pynte på figuren i oppgave 8 i kapittel @sec-r-ekstra (det er 100% lov å Google). Dette ser bedre ut:
...
Du kan laste ned de ferdige Excel-filene her for å kontrollere at du har fått det til: [`no3_prediksjoner.xlsx`](datasett/no3_prediksjoner.xlsx) og  [`no5_prediksjoner.xlsx`](datasett/no5_prediksjoner.xlsx).
